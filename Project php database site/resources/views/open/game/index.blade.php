                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <div class="w-auto border-2 rounded-lg border-gray-800 p-2">
                                <h2 class="font-bold text-lg">{{ $games[$i]->name }}</h2>
                                <h3>{{ $games[$i]->description }}</h3>
                                <h3 class="border-2 rounded-full border-gray-300 outline-double w-12 p-0.5 mt-1"><a href="{{ route('game.show', ['game' => $games[$i]->id]) }}">Show</a></h3>
                            </div>
                            @endfor
                            </div>
                            </tbody>
