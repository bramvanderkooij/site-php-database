                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($forums as $forum)
                                    <tr>
                                        <td onclick="window.location='{{ route('forum.show', ['forum' => $forum->id]) }}'"
                                        ...
                                        <td onclick="window.location='{{ route('forum.show', ['forum' => $forum->id]) }}'"
                                            style="cursor: pointer;"
                                            class="px-6 py-4 whitespace-nowrap text-sm max-w-4xl truncate font-medium text-gray-900">
                                            {{ $forum->description }}
                                        </td>
                                        <td onclick="window.location='{{ route('forum.show', ['forum' => $forum->id]) }}'"
                                            style="cursor: pointer;"
                                            class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <a href="{{ route('forum.show', ['forum' => $forum->id]) }}">Show</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
