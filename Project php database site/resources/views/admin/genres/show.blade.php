...
<!-- component -->
        <div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
            ...
            <div class="flex items-center px-6 py-3 bg-gray-900">
                <h1 class="mx-3 text-white font-semibold text-lg">Genre</h1>
        </div>
        <div class="py-4 px-6">
            <h1 class="text-2xl font-semibold text-gray-800">{{ $genre->name }}</h1>
            <p class="py-2 text-lg text-gray-700"></p>
                <a href="{{ route('genres.edit', ['genre' => $genre->id]) }}">Edit  </a>
                <a href="{{ route('genres.delete', ['genre' => $genre->id]) }}">Delete  </a>
@endsection
