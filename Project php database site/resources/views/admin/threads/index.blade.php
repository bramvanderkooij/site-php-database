                            ...
                            @foreach($threads as $thread)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <a href="{{ route('threads.show', ['thread' => $thread->id]) }}">Details</a>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <a href="{{ route('threads.edit', ['thread' => $thread->id]) }}">Edit</a>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <a href="{{ route('threads.delete', ['thread' => $thread->id]) }}">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
